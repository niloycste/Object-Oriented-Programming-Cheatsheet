...
The actual use case is parent class make sure that child classes should obey parent class instruction like make `abstract method's` method  in their class.
